...
// {
//     procedure DoGenerateBarcode(varBarcode: Code[100]; BarcodeType: Integer; var tempb: Codeunit "Temp Blob")
//     begin
//         Clear(tempb);
...
//     procedure SetResponseHeaders(varvalue: HttpHeaders)
//     begin
//         ResponseHeaders := varvalue
//     end;

//     procedure SetResponseContent(varvalue: HttpContent)
//     var
//         InStr: InStream;
//         OutStr: OutStream;
//     begin
//         tempblb.Blob.CreateInStream(InStr);
//         varvalue.ReadAs(InStr);
